...
(function () {
  ...
  var EN = {
    ...
    'hero.pill': 'Offline-first · End-to-End Zero-Knowledge Encrypted · Private Link Sharing',
    'hero.title1': 'Save, organize & share,',
    'hero.title2': ' anywhere',
    'hero.sub': 'ulink is a next-generation professional bookmark and knowledge management system: tree-nested sub-bookmarks, multidimensional attribute filtering, end-to-end zero-knowledge encryption, and private link sharing with one-tap saves.',
    'hero.explore': 'Explore Features',
    'hero.note': 'Ready out-of-the-box · Local authority storage · End-to-end zero-knowledge encrypted · Private link sharing',
    ...
    'create.eyebrow': 'Private Share',
    'create.title': 'Private Link Sharing, Direct & Secure',
    'create.d1': 'No public directories and no search engine indexing. Access is granted exclusively through dedicated private links. Whether sending to friends, colleagues, or syncing across your own devices, recipients can view instantly in any browser without signing in, and save a private copy with one tap.',
    'create.d2': 'Every shared group embeds a dedicated rich-text notebook — attach notes, usage guides, highlights, or task checklists, and embed bookmarks directly using @ references. Keep links and thoughts unified for clean, structured handoffs.',
    'cm.n1': 'Creator · Outgoing Link',
    'cm.n2': 'Visitor · Zero Sign-up Reading',
    'cm.n3': '⚡ One-click Save Copy',
    'cm.n4': '📱 Multi-device Responsive',
    'cm.public': 'Private Share',
    'cm.fork': 'Save Copy',
    ...
    'a4': 'It travels across browsers and devices, supports sub-bookmark nesting, rich-text notebook groups, pinyin search, private link sharing, and one-click capture via extension.',
